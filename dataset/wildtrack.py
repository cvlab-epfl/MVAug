...
class WildtrackSet(SceneBaseSet):
    ...
    def _get_homography(self, view_id):
        ...
        H = geometry.get_ground_plane_homography(K, self.calibs[view_id].R, self.calibs[view_id].T, self.world_origin_shift, self.homography_output_size, self.groundplane_scale, grounplane_size_for_scale=[180,80])
